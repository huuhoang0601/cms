...
&#9989; Give option to customer to accept direct refund in there Wallet (TerraWallet) / [As a store credit discount coupon](https://wordpress.org/plugins/add-coupon-by-link-for-woocommerce/)
